 ...
 * @author hengxin
 * @date Jun 22, 2014
 * @description interface to the superuser shell on Android devices with some helper functions.
 * 
 * See <url>https://code.google.com/p/market-enabler/source/
 * browse/branches/MarketAccess/src/ru/org/amip/MarketAccess/utils/ShellInterface.java</url>
 * 
 * Also see the StackOverflow question "Setting system time of ROOTED phone" 
 * and its answer <url>http://stackoverflow.com/a/8752130/1833118</url>
 */
